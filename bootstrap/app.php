...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        $middleware->alias([
            ...
            'throttle.refresh' => \Illuminate\Routing\Middleware\ThrottleRequests::class.':100,1',
            'throttle.validation' => \Illuminate\Routing\Middleware\ThrottleRequests::class.':100,1',
            'throttle.webhook' => \Illuminate\Routing\Middleware\ThrottleRequests::class.':100,1',
            'throttle.subscription' => \Illuminate\Routing\Middleware\ThrottleRequests::class.':100,1',
