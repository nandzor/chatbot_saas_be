...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('chat_sessions', function (Blueprint $table) {
            ...
            $table->enum('priority', ['low', 'medium', 'high', 'urgent'])->default('medium')->after('session_status');
            ...
            $table->index(['priority', 'session_status']);
        ...
        Schema::table('messages', function (Blueprint $table) {
            ...
            $table->timestamp('sent_at')->nullable()->after('message_status');
            $table->timestamp('delivered_at')->nullable()->after('sent_at');
            $table->timestamp('read_at')->nullable()->after('delivered_at');
            
            // Bot Integration
            $table->boolean('is_bot_generated')->default(false)->after('read_at');
    ...
    public function down(): void
    {
        ...
        Schema::table('messages', function (Blueprint $table) {
            $table->dropIndex(['session_id', 'sent_at']);
            $table->dropIndex(['sender_type', 'sent_at']);
            $table->dropIndex(['sender_agent_id', 'sent_at']);
        ...
        Schema::table('chat_sessions', function (Blueprint $table) {
            ...
            $table->dropIndex(['priority', 'session_status']);
