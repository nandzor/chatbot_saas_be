...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('customers', function (Blueprint $table) {
            ...
            $table->unique(['organization_id', 'channel', 'channel_user_id'], 'customers_org_channel_user_unique');
            $table->unique(['organization_id', 'email'], 'customers_org_email_unique')->where('email IS NOT NULL');
            $table->unique(['organization_id', 'phone'], 'customers_org_phone_unique')->where('phone IS NOT NULL');
        });
    }
