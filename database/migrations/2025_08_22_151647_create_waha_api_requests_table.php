...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('waha_api_requests', function (Blueprint $table) {
            ...
            $table->unique(['organization_id', 'request_id'], 'waha_api_requests_org_request_id_unique');
            $table->unique(['session_id', 'request_id'], 'waha_api_requests_session_request_id_unique');
        });
    }
