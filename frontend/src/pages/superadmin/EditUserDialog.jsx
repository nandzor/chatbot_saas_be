    ...
    if (user) {
      setFormData({
        ...
        metadata: {
          ...
          hire_date: user.metadata?.hire_date || '',
          manager: user.metadata?.manager || '',
          cost_center: user.metadata?.cost_center || ''
        }
      });
          ...
          <div className="p-6 space-y-6 pointer-events-auto">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Update user account and security settings
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Password Section */}
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {passwordChanged ? 'Password will be updated' : 'Leave blank to keep current password'}
                      </p>
                    </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Update user's organization, department, and role assignment
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Update additional employee details and metadata
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  See how the user will appear after updates
                </CardDescription>
              </CardHeader>
              <CardContent>
