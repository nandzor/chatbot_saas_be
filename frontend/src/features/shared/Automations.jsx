/**
 * Enhanced Automations Component
 * Automations dengan DataTable dan enhanced components
 */
...
export default withErrorHandling(Automations, {
  context: 'Automations Component'
});
